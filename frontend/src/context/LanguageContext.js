...
const dict = {
  en: {
    ...
    hero: {
      eyebrow: "Global Export & Import • Since 2015",
      title: "Your Trusted Partner in Global Trade",
      subtitle:
        "Commercion Exim Pvt Ltd connects Indian excellence with buyers across 60+ countries — engineering, chemicals, textiles, handicrafts, EVs and more, delivered on time, every time.",
      cta: "Get a Quote",
      cta2: "Explore Products",
      stat1: "60+",
      stat1_l: "Countries served",
      stat2: "1,200+",
      stat2_l: "Verified suppliers",
      stat3: "10+",
      stat3_l: "Product verticals",
      stat4: "99.4%",
      stat4_l: "On-time delivery",
    },
    about: {
      eyebrow: "About Commercion Exim",
      title: "Built on integrity. Delivered with precision.",
      body:
        "For over a decade, we have quietly become one of India's most reliable export-import houses — sourcing directly from vetted manufacturers, enforcing rigorous quality control, and handling end-to-end logistics so our global partners can trust every shipment.",
  ...
  hi: {
    ...
    hero: {
      eyebrow: "वैश्विक निर्यात व आयात • 2015 से",
      title: "वैश्विक व्यापार में आपका विश्वसनीय साथी",
      subtitle:
        "कॉमर्सियन एक्ज़िम प्रा. लि. भारतीय उत्कृष्टता को 60+ देशों के खरीदारों से जोड़ती है — इंजीनियरिंग, केमिकल्स, वस्त्र, हस्तशिल्प, ईवी और बहुत कुछ, समय पर, हर बार।",
      cta: "कोटेशन प्राप्त करें",
      cta2: "उत्पाद देखें",
      stat1: "60+",
      stat1_l: "देशों में सेवा",
      stat2: "1,200+",
      stat2_l: "सत्यापित आपूर्तिकर्ता",
      stat3: "10+",
      stat3_l: "उत्पाद श्रेणियाँ",
      stat4: "99.4%",
      stat4_l: "समय पर डिलीवरी",
    },
    about: {
      eyebrow: "कॉमर्सियन एक्ज़िम के बारे में",
      title: "ईमानदारी पर आधारित। सटीकता से दी गई।",
      body:
        "एक दशक से अधिक समय से, हम भारत के सबसे विश्वसनीय एक्सपोर्ट-इंपोर्ट हाउसों में से एक हैं — सत्यापित निर्माताओं से सीधा सोर्सिंग, सख्त गुणवत्ता नियंत्रण, और सम्पूर्ण लॉजिस्टिक्स।",
